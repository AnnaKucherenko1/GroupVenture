...
export default function Map({ markers, selectedMarker, onMarkerClick, onMapClick, center}: MapProps) {
  ...
  const renderMarkers = () => {
    ...
    return markers.map((position, key) => <Marker key={key} position={position as google.maps.LatLngLiteral} onClick={() => handleMarkerClick(position)}/>)
  }
  // useEffect(() => {
